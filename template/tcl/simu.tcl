...
create_bd_cell -type ip -vlnv www.eurecom.fr:ip:sha256:1.0 t0
create_bd_cell -type ip -vlnv www.eurecom.fr:ip:scanner:1.0 scanner_ip
...
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE} CONFIG.INTERFACE_MODE {MASTER}] [get_bd_cells axi_vip_2]
...
#create_bd_port -dir I -type reset aresetn
make_bd_pins_external  [get_bd_pins axi_vip_0/aresetn]
set_property name aresetn [get_bd_ports aresetn_0]

connect_bd_net [get_bd_pins scanner_ip/scan_output] [get_bd_pins t0/scan_output]
connect_bd_net [get_bd_pins scanner_ip/scan_ck_enable] [get_bd_pins t0/scan_ck_enable]
connect_bd_net [get_bd_pins scanner_ip/scan_input] [get_bd_pins t0/scan_input]
connect_bd_net [get_bd_pins scanner_ip/scan_enable] [get_bd_pins t0/scan_enable]

connect_bd_net [get_bd_ports aclk] [get_bd_pins t0/s00_axi_aclk]
connect_bd_net [get_bd_ports aresetn] [get_bd_pins t0/s00_axi_aresetn]
...
connect_bd_net [get_bd_ports aclk] [get_bd_pins axi_vip_2/aclk]
connect_bd_net [get_bd_ports aresetn] [get_bd_pins axi_vip_2/aresetn]
connect_bd_net [get_bd_ports aclk] [get_bd_pins scanner_ip/aclk]
connect_bd_net [get_bd_ports aresetn] [get_bd_pins scanner_ip/aresetn]
...
connect_bd_intf_net [get_bd_intf_pins axi_vip_0/S_AXI] [get_bd_intf_pins scanner_ip/m00_axi]
connect_bd_intf_net [get_bd_intf_pins axi_vip_1/M_AXI] [get_bd_intf_pins scanner_ip/s00_axi]
connect_bd_intf_net [get_bd_intf_pins axi_vip_2/M_AXI] [get_bd_intf_pins t0/s00_axi]

connect_bd_net [get_bd_pins fifo_generator_t0/almost_full] [get_bd_pins scanner_ip/almost_full_t0]
connect_bd_net [get_bd_pins fifo_generator_t0/din] [get_bd_pins scanner_ip/data_in_t0]
connect_bd_net [get_bd_pins fifo_generator_t0/wr_en] [get_bd_pins scanner_ip/wr_en_t0]
connect_bd_net [get_bd_pins fifo_generator_t0/empty] [get_bd_pins scanner_ip/empty_t0]
connect_bd_net [get_bd_pins fifo_generator_t0/rd_en] [get_bd_pins scanner_ip/rd_en_t0]
connect_bd_net [get_bd_pins fifo_generator_t0/dout] [get_bd_pins scanner_ip/data_out_t0]

connect_bd_net [get_bd_pins fifo_generator_t1/almost_full] [get_bd_pins scanner_ip/almost_full_t1]
connect_bd_net [get_bd_pins fifo_generator_t1/din] [get_bd_pins scanner_ip/data_in_t1]
connect_bd_net [get_bd_pins fifo_generator_t1/wr_en] [get_bd_pins scanner_ip/wr_en_t1]
connect_bd_net [get_bd_pins fifo_generator_t1/empty] [get_bd_pins scanner_ip/empty_t1]
connect_bd_net [get_bd_pins fifo_generator_t1/rd_en] [get_bd_pins scanner_ip/rd_en_t1]
connect_bd_net [get_bd_pins fifo_generator_t1/dout] [get_bd_pins scanner_ip/data_out_t1]
...
assign_bd_address [get_bd_addr_segs {t0/s00_axi/reg0 }]
